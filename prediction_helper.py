...
model_young_path = os.path.join(current_dir, "artifacts/model_young.joblib")
# Load the model
model_young = joblib.load(model_young_path)

model_rest_path = os.path.join(current_dir, "artifacts/model_rest.joblib")
model_rest = joblib.load(model_rest_path)

# Construct the full path of the scaler file
scaler_young_path = os.path.join(current_dir, "artifacts/scaler_young.joblib")
# Load the scaler
scaler_young = joblib.load(scaler_young_path)

scaler_rest_path = os.path.join(current_dir, "artifacts/scaler_rest.joblib")
